...
namespace WorkingWithCollections
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            /* Old collection (ArrayList) in which we can add not the same class
            ...
            */
            ...
            List<Car> myList = new List<Car>()
            {
                ...
                //new Car() {Make = "Oldsmobile", Model = "Cutlas Supreme", VIN = "E5" }, is also fine
